...
Wyjście/Output:
Output consists of several lines: firstly, the whole output (as in the RPN algorithm) list is printed, the following lines are the operations executed from left to right.
